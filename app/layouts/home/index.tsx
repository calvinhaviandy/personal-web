  ...
  return (
    <div className="flex md:flex-row flex-col lg:h-[80vh] pb-32 lg:mt-0 mt-8 lg:gap-52 gap-20 items-center justify-center">
      ...
      <div className="md:order-2 order-1">
        ...
        >
          <div className="transform-perserve-3d relative before:absolute before:md:w-[300px] before:w-[300px] before:h-[400px] before:lg:h-[500px] before:lg:w-[400px]  before:-top-6 before:-left-8 before:bg-transparent before:border-2 before:transform before:translate before:border-blue-500  bg-gradient-to-b from-blue-500 via-blue-600 to-transparent rounded-md hover:shadow-sm cursor-pointer active:scale-95 transition-all">
